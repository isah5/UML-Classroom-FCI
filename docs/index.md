...
Dado os fatores apresentados, trataremos em nosso projeto possíveis soluções a serem aplicadas a fim de ratificar todo e qualquer dano que fora apresentado. Com isso, teremos como iniciativa a criação de um sistema para atendimento de pedidos e localização da fábrica de pizza mais próxima para entrega. Além de um sistema para suporte às operações da fábrica de pizzas, a fim de trazer melhoria e resultados ao comércio em questão.
